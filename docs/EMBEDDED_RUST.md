...
Shared BSON matching, basic projection, global sorting, and retained find cursors use this same boundary. Updates,
replacements, aggregation, and distinct remain `Unsupported`
