...
pub use core::{
    ...
    GlobalIndexAsyncOptions, GlobalIndexAsyncProcessReport, GlobalIndexAsyncShardOutcome,
    GlobalIndexAsyncShardReport, GlobalIndexAsyncShardStatus, GlobalIndexAsyncStatus,
    ...
    GlobalIndexRoutingPlan, GlobalIndexStorageTopology, GlobalIndexValidationIssue,
